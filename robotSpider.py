...
if __name__ == '__main__':
    ...
    SUMMARYFILE = args.inputfile+"_summary.csv"
    USERAGENTFILE = args.inputfile+"_useragents.csv"
    SITEMAPFILE = args.inputfile+"_sitemaps.csv"
    RULESFILE = args.inputfile+"_rules.csv"
